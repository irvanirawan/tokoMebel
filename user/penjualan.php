...
<br><br><br><br>
    <div align="center">
        <h1><span class="glyphicon glyphicon-shopping-cart"></span>     Data Customer & Entry Penjualan</h1>
    </div>
...
<div class="col-md-13">
 ...
 <div class="container-fluid form-outline nav navbar-right">
        <span ><a href="pilihbarangumum.php" class="box-title btn btn-primary form-group pull-right" 
		style="width: 200px; height: 35px;">Penjualan Umum</h5></a></span>
  </div>
  ...
  <div class="container-fluid form-outline nav navbar-left">
        ...
        <form method="post" action="penjualan.php">
                <div class="input-group input-group-sm" style="width: 250px;">
                    <input type="text" name="katakunci" class="form-control pull-left" placeholder="Cari Customer..." 
...
<h5><table class="table table-bordered table-striped table-hover table-responsive"></h5>
	<tr>
        ...
        <th class="col-md-2" style="text-align: center"><h4><b>Jenis Customer<b></h4></th>
		<th class="col-md-2" style="text-align: center"><h4><b>Alamat<b></h4></th>
...
<?php 
  ...
  <tr>
    ...
    <td style="text-align: center"> <a href="pilihbarang.php?id=<?php echo $b['id_customer']; ?> 
	"class="btn btn-success" style="width: 70px;"><b>Jual</b></a></td>
  </tr>
