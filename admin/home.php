...
<h5><table id="example" class="table table-bordered table-striped table-hover table-responsive"></h5>
	<tr>
		...
		<th colspan="2" class="col-md-2" style="text-align: center"><h5><b>Option<b></h5></th>
	</tr>
	<?php
include('koneksi.php');
if (isset($_POST['cari'])) {
...
?>
		<tr>
            ...
            <td style="text-align: center"><a href="edit_barang.php?id=<?php echo $b['id_barang']; ?>" class="btn btn-warning"> Edit</a></td>
            <td style="text-align: center"><a href="hapus_barang.php?id=<?php echo $b['id_barang']; ?>" class="btn btn-danger">Hapus</a></td>
			</tr>		
		<?php 
	}
	?>
...
<h5><table id="example" class="table table-bordered table-striped table-hover table-responsive"></h5>
	<tr>
		...
		<th colspan="3" class="col-md-2" style="text-align: center"><h5><b>Option<b></h5></th>
	</tr>
...
?>
                <tr>
					...
					<td style="text-align: center"><a href="edit_customer.php?id=<?php echo $b['id_customer']; ?>" class="btn btn-warning">Edit</a></td>
                    <td style="text-align: center"><a href="inputhargabarang.php?id=<?php echo $b['id_customer']; ?>" class="btn btn-info">Entry</a></td>
                    <td style="text-align: center"><a href="hapus_customer.php?id=<?php echo $b['id_customer']; ?>" class="btn btn-danger">Hapus</a></td>
                </tr>
