...
<div class="col-md-13">
 ...
 <div class="container-fluid form-outline nav navbar-right">
        <span ><a href="input_customer.php" class="box-title btn btn-primary form-group pull-right" 
		style="width: 200px; height: 35px;">Tambah Customer</h5></a></span>
  </div>
...
<h5><table class="table table-bordered table-striped table-hover table-responsive"></h5>
	<tr>
		...
		<th colspan="3" class="col-md-2" style="text-align: center"><h4><b>Option<b></h4></th>
	</tr>
